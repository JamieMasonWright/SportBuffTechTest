...
import com.sportbuff.sdk.ui.Utils
import com.sportbuff.sdk.ui.sportbuff.SportBuffViewModel
import com.sportbuff.sdk.ui.sportbuff.CustomViewState
import com.bumptech.glide.Glide
import com.sportbuff.sdk.custom.SportBuffustomConstraintLayout
...
class SportBuffLayout(
    context: Context,
    attrs: AttributeSet
): SportBuffustomConstraintLayout<CustomViewState, SportBuffViewModel>(context, attrs) {

    private var isAnswered = false
    private var buffTimeToShow = 0

    override val viewModel = SportBuffViewModel()
